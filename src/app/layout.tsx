...
export const metadata: Metadata = {
  title: "Reliable Landscaping & Snow Plowing in Newton, MA",
  description: "Professional lawn care, yard maintenance, and snow removal from Victor Pineda Landscaping. Local, dependable, and fairly priced. Serving Newton and nearby towns.",
  keywords: "landscaping Newton MA, lawn care Newton, snow plowing Newton, yard maintenance, professional landscaper",
  metadataBase: new URL("https://victorpinedaelandscaping.com"),
  alternates: {
    canonical: "https://victorpinedaelandscaping.com",
  },
  openGraph: {
    title: "Victor Pineda Landscaping - Newton, MA",
    description: "Professional lawn care and snow plowing services serving Newton and surrounding communities. 5-star rated local landscaper.",
    siteName: "Victor Pineda Landscaping",
    type: "website",
    images: [
      {
        url: "http://img.b2bpic.net/free-psd/professional-lawn-gardening-services-advertisement_505751-8151.jpg",
        alt: "Professional lawn care in Newton, MA",
      },
    ],
  },
  twitter: {
    ...
    title: "Victor Pineda Landscaping - Newton, MA",
    description: "Professional lawn care and snow plowing services. 5-star rated.",
    images: ["http://img.b2bpic.net/free-psd/professional-lawn-gardening-services-advertisement_505751-8151.jpg"],
  },
  robots: {
    index: true,
    follow: true,
